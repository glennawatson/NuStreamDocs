...
/// to "no override".
/// </summary>
/// <param name="Title">Optional section title; <see cref="string.Empty"/> when not set.</param>
/// <param name="OrderedEntries">
/// Explicit child ordering; entries may reference page filenames
...
internal readonly record struct PagesFile(string Title, string[] OrderedEntries, bool Hide)
{
    /// <summary>Gets the empty (no-override) instance.</summary>
    public static PagesFile Empty { get; } = new(string.Empty, [], Hide: false);
}
