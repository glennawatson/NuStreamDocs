...
public static class HlslLexer
{
    ...
    private static readonly SearchValues<byte> KeywordTypeFirst = SearchValues.Create("ABCRSTbdfhimuv"u8);

    /// <summary>First-byte set for declaration keywords.</summary>
    private static readonly SearchValues<byte> KeywordDeclarationFirst = SearchValues.Create("cegilnoprstuv"u8);
