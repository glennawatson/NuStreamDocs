...
public static class CrystalLexer
{
    ...
    private static readonly SearchValues<byte> KeywordFirst = SearchValues.Create("abceifnorstwy"u8);

    /// <summary>First-byte set for type keywords.</summary>
    private static readonly SearchValues<byte> KeywordTypeFirst = SearchValues.Create("ABCFHINSTU"u8);

    /// <summary>First-byte set for declaration keywords.</summary>
    private static readonly SearchValues<byte> KeywordDeclarationFirst = SearchValues.Create("acdefilmpst"u8);
