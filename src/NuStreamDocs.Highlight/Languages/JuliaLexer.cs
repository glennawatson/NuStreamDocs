...
public static class JuliaLexer
{
    ...
    /// <summary>First-byte set for the <c>#</c> comment dispatch (line and <c>#=</c> block).</summary>
    ...
    /// <summary>Builds the Julia lexer.</summary>
    ...
    private static Lexer Build()
    {
        ...
        [
            ...
            // #= ... =# block comment dispatch must precede the # line-comment rule.
