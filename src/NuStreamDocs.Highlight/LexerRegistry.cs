...
public sealed class LexerRegistry
{
    ...
    private static Dictionary<byte[], Lexer> BuildBuiltInAliasMap() =>
        new(ByteArrayComparer.Instance)
        {
            ...
            [[.. "toml"u8]] = PassThroughLexer.Instance,
            [[.. "c"u8]] = PassThroughLexer.Instance,
            [[.. "cpp"u8]] = PassThroughLexer.Instance,
            [[.. "c++"u8]] = PassThroughLexer.Instance,
            [[.. "fsharp"u8]] = FSharpLexer.Instance,
            [[.. "fs"u8]] = FSharpLexer.Instance,
            [[.. "f#"u8]] = FSharpLexer.Instance,
            [[.. "go"u8]] = PassThroughLexer.Instance,
            [[.. "golang"u8]] = PassThroughLexer.Instance,
            [[.. "rust"u8]] = PassThroughLexer.Instance,
            [[.. "rs"u8]] = PassThroughLexer.Instance,
            [[.. "java"u8]] = PassThroughLexer.Instance,
            [[.. "kotlin"u8]] = PassThroughLexer.Instance,
            [[.. "kt"u8]] = PassThroughLexer.Instance,
            [[.. "swift"u8]] = PassThroughLexer.Instance,
            [[.. "ruby"u8]] = PassThroughLexer.Instance,
            [[.. "rb"u8]] = PassThroughLexer.Instance,
            [[.. "php"u8]] = PassThroughLexer.Instance,
            [[.. "lua"u8]] = PassThroughLexer.Instance,
            [[.. "sql"u8]] = PassThroughLexer.Instance,
            [[.. "css"u8]] = PassThroughLexer.Instance,
            [[.. "scss"u8]] = PassThroughLexer.Instance,
            [[.. "less"u8]] = PassThroughLexer.Instance,
            [[.. "markdown"u8]] = PassThroughLexer.Instance,
            [[.. "md"u8]] = PassThroughLexer.Instance,
            [[.. "dockerfile"u8]] = PassThroughLexer.Instance,
            [[.. "ini"u8]] = PassThroughLexer.Instance,
            [[.. "cfg"u8]] = PassThroughLexer.Instance,
            [[.. "conf"u8]] = PassThroughLexer.Instance,
            [[.. "makefile"u8]] = PassThroughLexer.Instance,
            [[.. "make"u8]] = PassThroughLexer.Instance,
            ...
            [[.. "nix"u8]] = PassThroughLexer.Instance,
