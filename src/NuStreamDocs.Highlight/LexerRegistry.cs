...
public sealed class LexerRegistry
{
    ...
    private static Dictionary<byte[], Lexer> BuildBuiltInAliasMap() =>
        new(ByteArrayComparer.Instance)
        {
            ...
            [[.. "glsl"u8]] = GlslLexer.Instance,
            [[.. "vert"u8]] = GlslLexer.Instance,
            [[.. "frag"u8]] = GlslLexer.Instance,
            [[.. "geom"u8]] = GlslLexer.Instance,
            [[.. "tesc"u8]] = GlslLexer.Instance,
            [[.. "tese"u8]] = GlslLexer.Instance,
            [[.. "comp"u8]] = GlslLexer.Instance,
            [[.. "hlsl"u8]] = HlslLexer.Instance,
            [[.. "fx"u8]] = HlslLexer.Instance,
            [[.. "fxh"u8]] = HlslLexer.Instance,
            [[.. "http"u8]] = HttpLexer.Instance,
            [[.. "rst"u8]] = RstLexer.Instance,
            [[.. "rest"u8]] = RstLexer.Instance,
            [[.. "restructuredtext"u8]] = RstLexer.Instance,
