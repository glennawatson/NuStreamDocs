...
{
    /// <summary>Extension members for <c>LunrOptions</c>.</summary>
    /// <param name="options">The source options.</param>
    extension(in LunrOptions options)
    {
        ...
        public LunrOptions WithOutputSubdirectory(in PathSegment subdirectory) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions WithLanguage(in ApiCompatString language) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions WithLanguage(byte[] language) =>
        ...
        /// <param name="language">UTF-8 language-code bytes.</param>
        /// <returns>The updated options.</returns>
        public LunrOptions WithLanguage(ReadOnlySpan<byte> language) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions WithMinTokenLength(int minTokenLength) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions WithCompression(SearchCompression compression) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions
            WithSearchableFrontmatterKeys(params ApiCompatString[] keys) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions WithSearchableFrontmatterKeys(params byte[][] keys) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions
            AddSearchableFrontmatterKeys(params ApiCompatString[] keys) =>
            keys.Length is 0
                ? options
                : options with
                {
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions AddSearchableFrontmatterKeys(params byte[][] keys) =>
            keys.Length is 0
                ? options
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions AddSearchableFrontmatterKeys(ReadOnlySpan<byte> key) =>
            options with
            {
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions ClearSearchableFrontmatterKeys() =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions WithExtraStopwords(params ApiCompatString[] stopwords) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions WithExtraStopwords(params byte[][] stopwords) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions AddExtraStopwords(params ApiCompatString[] stopwords) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions AddExtraStopwords(params byte[][] stopwords) =>
            stopwords.Length is 0
                ? options
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions AddExtraStopwords(ReadOnlySpan<byte> stopword) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions ClearExtraStopwords() =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions WithSectionPriorities(in ApiCompatString value) =>
        ...
        /// <returns>The updated options.</returns>
        public LunrOptions WithSectionPriorities(byte[] value) =>
        ...
        /// <param name="value">UTF-8 section-priority bytes.</param>
        /// <returns>The updated options.</returns>
        public LunrOptions WithSectionPriorities(ReadOnlySpan<byte> value) =>
