...
{
    /// <summary>Extension members for <c>OptimizeOptions</c>.</summary>
    /// <param name="options">Options to update.</param>
    extension(OptimizeOptions options)
    {
        ...
        public OptimizeOptions WithExtensions(params string[] extensions) =>
            options with { Extensions = extensions.EncodeUtf8Array() };
        ...
        /// <returns>The updated options.</returns>
        public OptimizeOptions WithExtensions(params byte[][] extensions) =>
            options with { Extensions = extensions };
        ...
        /// <returns>The updated options.</returns>
        public OptimizeOptions AddExtensions(params string[] extensions) =>
        ...
        /// <returns>The updated options.</returns>
        public OptimizeOptions AddExtensions(params byte[][] extensions) =>
            extensions.Length is 0
                ? options
        ...
        /// <returns>The updated options.</returns>
        public OptimizeOptions AddExtensions(ReadOnlySpan<byte> extension) =>
            options with { Extensions = ArrayJoiner.Concat(options.Extensions, [extension.ToArray()]) };

        /// <summary>Empties the extension list — the plugin becomes a no-op until repopulated.</summary>
        /// <returns>The updated options.</returns>
        public OptimizeOptions ClearExtensions() => options with { Extensions = [] };
    }
}
