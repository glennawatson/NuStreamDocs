...
internal static partial class PrivacyLoggingHelper
{
    ...
    internal static partial void LogLocalizationStart(ILogger logger, int assetCount, string outputRoot);
    ...
    internal static partial void LogDownloadSuccess(ILogger logger, string url, string localPath);
    ...
    internal static partial void LogDownloadFailure(ILogger logger, string url, string localPath);
    ...
    internal static partial void LogCacheHit(ILogger logger, string url, string cachePath);
    ...
    internal static partial void LogFinalizeSummary(ILogger logger, int localizedCount, int failedCount, int cachedCount);
    ...
    internal static partial void LogAuditWrite(ILogger logger, string manifestPath, int urlCount);
    ...
    internal static partial void LogIterationStart(ILogger logger, int iteration, int pendingCount, int parallelism);
    ...
    internal static partial void LogIterationComplete(ILogger logger, int iteration, int processedCount, int failedCount,
    ...
    internal static partial void LogIterationProgress(ILogger logger, int iteration, int completedCount, int totalCount);
}
