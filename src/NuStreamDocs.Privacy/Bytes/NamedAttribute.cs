...
/// <param name="End">Offset one past the closing quote.</param>
...
internal readonly record struct NamedAttribute(int Start, int End, int ValueStart, int ValueEnd)
{
    /// <summary>Gets the sentinel value returned when the attribute is absent.</summary>
    public static NamedAttribute None => new(-1, -1, -1, -1);
