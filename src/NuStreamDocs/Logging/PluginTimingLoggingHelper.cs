...
internal static partial class PluginTimingLoggingHelper
{
    ...
    internal static partial void LogPluginTimingHeader(ILogger logger);
    ...
    internal static partial void LogPluginTimingRow(ILogger logger, string pluginName, double elapsedSeconds);
    ...
    internal static void LogPluginTimingRow(ILogger logger, ReadOnlySpan<byte> pluginName, double elapsedSeconds)
    {
    ...
    internal static partial void LogPluginTimingDebug(ILogger logger, string pluginName, double elapsedSeconds);
    ...
    /// <param name="pluginName">Plugin name as UTF-8 bytes.</param>
    /// <param name="elapsedSeconds">Total time in seconds.</param>
    internal static void LogPluginTimingDebug(ILogger logger, ReadOnlySpan<byte> pluginName, double elapsedSeconds)
    {
