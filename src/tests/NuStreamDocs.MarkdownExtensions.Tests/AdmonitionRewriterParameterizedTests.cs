...
/// <summary>Parameterized type-token coverage for AdmonitionRewriter.</summary>
public class AdmonitionRewriterParameterizedTests
{
    /// <summary>Each recognized admonition type produces a corresponding class on the wrapper.</summary>
