...
/// <summary>Parameterised collapse / type-token coverage for DetailsRewriter.</summary>
public class DetailsRewriterParameterisedTests
{
    ...
    /// <summary>Each recognised type token becomes a class on the wrapper.</summary>
