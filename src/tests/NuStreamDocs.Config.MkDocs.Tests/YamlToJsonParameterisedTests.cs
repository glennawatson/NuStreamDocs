...
/// <summary>Parameterised YAML inputs covering YamlToJson scalar, list, and quoting branches.</summary>
public class YamlToJsonParameterisedTests
{
    /// <summary>Recognised true/false/null scalar literals map to JSON literals.</summary>
