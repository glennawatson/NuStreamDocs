...
/// <summary>Parameterised inputs for NavTreeBuilder covering every combination of sort, prune, indexes, and hide-empty toggles.</summary>
public class NavTreeBuilderParameterisedTests
{
