...
public class HostFilterByteTests
{
    ...
    {
        HostFilter filter = new(PrivacyTestHelpers.Utf8("analytics.example"), null);
    ...
    {
        HostFilter filter = new(null, PrivacyTestHelpers.Utf8("only.example"));
    ...
    public async Task PatternFollowupHandlesExclude()
    {
        HostFilter filter = new(
            ...
            null,
            null,
            PrivacyTestHelpers.Utf8("*tracking*"));
    ...
    {
        HostFilter filter = new(PrivacyTestHelpers.Utf8("example.com"), null);
    ...
    {
        HostFilter filter = new(null, PrivacyTestHelpers.Utf8("example.com"));
