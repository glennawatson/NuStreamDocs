...
/// <summary>Parameterised key + value-shape tests for FrontmatterValueExtractor.AppendKeysTo.</summary>
public class FrontmatterValueExtractorParameterisedTests
{
