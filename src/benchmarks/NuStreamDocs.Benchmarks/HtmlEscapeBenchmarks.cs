...
/// every escape branch.
/// </remarks>
[DebuggerDisplay("HtmlEscapeBenchmarks: clean={_clean}, heavy={_heavy}")]
[ShortRunJob]
[MemoryDiagnoser]
public class HtmlEscapeBenchmarks
{
    ...
    public void Setup()
    {
        ...
        {
            _ = clean.Append("plain ascii line without any escape candidates here.\n");
            _ = heavy.Append("Tom & Jerry <said> \"hi\" 'there' & 'again' >> end\n");
        }
