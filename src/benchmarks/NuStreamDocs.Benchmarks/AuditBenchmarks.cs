...
/// </summary>
[DebuggerDisplay("AuditBenchmarks: PageSizeKb={PageSizeKb}, Flawed={Flawed}")]
[ShortRunJob]
[MemoryDiagnoser]
public class AuditBenchmarks
{
    ...
    /// <summary>Space reserved for the page shell outside the repeated body.</summary>
    private const int PageShellCapacity = 256;
    ...
    public void Setup()
    {
        ...
        var block = (Flawed ? FlawedBlock : CleanBlock).AsSpan();
        ...
        StringBuilder page = new(body.Length + PageShellCapacity);
        _ = page.Append(Flawed
