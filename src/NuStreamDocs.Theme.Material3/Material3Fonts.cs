...
/// <summary>Self-hosted-font defaults for the Material 3 theme: Roboto for body text, Roboto Mono for code (the Material Design 3 typeface). Pass to <c>builder.UseFonts(...)</c>.</summary>
public static class Material3Fonts
{
    ...
    /// <summary>Gets the font configuration: Roboto (body) and Roboto Mono (code), latin + latin-ext, self-hosted from Google Fonts.</summary>
