...
internal static partial class ServeLoggingHelper
{
    ...
    internal static partial void LogServerStart(ILogger logger, string url, string inputRoot, string outputRoot);
    ...
    internal static partial void LogRebuildStart(ILogger logger, int changeCount);
    ...
    internal static partial void LogRebuildComplete(ILogger logger, long elapsedMs, int connectedClients);
    ...
    internal static partial void LogRebuildFailed(ILogger logger, Exception exception);
    ...
    internal static partial void LogWatchEvent(ILogger logger, WatcherChangeTypes changeType, string path);
    ...
    internal static partial void LogWatchError(ILogger logger, Exception exception);
    ...
    internal static partial void LogServerStopping(ILogger logger);
}
