...
{
    /// <summary>Extension members for <c>SqliteOptions</c>.</summary>
    /// <param name="options">The source options.</param>
    extension(in SqliteOptions options)
    {
        ...
        public SqliteOptions WithOutputSubdirectory(in PathSegment subdirectory) =>
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions WithMinTokenLength(int minTokenLength) =>
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions WithSearchableFrontmatterKeys(
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions WithSearchableFrontmatterKeys(params byte[][] keys) =>
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions AddSearchableFrontmatterKeys(
            params ApiCompatString[] keys) =>
            keys.Length is 0
                ? options
                : options with
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions AddSearchableFrontmatterKeys(params byte[][] keys) =>
            keys.Length is 0
                ? options
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions AddSearchableFrontmatterKeys(ReadOnlySpan<byte> key) =>
            options with
            {
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions ClearSearchableFrontmatterKeys() =>
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions WithExcludePathPrefixes(
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions WithExcludePathPrefixes(params byte[][] prefixes) =>
        ...
        public SqliteOptions
            AddExcludePathPrefixes(params ApiCompatString[] prefixes) =>
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions AddExcludePathPrefixes(params byte[][] prefixes) =>
            prefixes.Length is 0
                ? options
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions AddExcludePathPrefixes(ReadOnlySpan<byte> prefix) =>
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions ClearExcludePathPrefixes() =>
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions WithIndexFullBody(bool indexFullBody) =>
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions WithSectionPriorities(in ApiCompatString value) =>
        ...
        /// <returns>The updated options.</returns>
        public SqliteOptions WithSectionPriorities(byte[] value) =>
        ...
        /// <param name="value">UTF-8 section-priority bytes.</param>
        /// <returns>The updated options.</returns>
        public SqliteOptions WithSectionPriorities(ReadOnlySpan<byte> value) =>
