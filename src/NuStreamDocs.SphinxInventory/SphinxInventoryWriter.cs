...
internal static class SphinxInventoryWriter
{
    ...
    public static void Write(string outputPath, SphinxInventoryOptions options, (string Id, string Url)[] entries)
    {
    ...
    private static void WriteCompressedBody(Stream stream, (string Id, string Url)[] entries)
    {
