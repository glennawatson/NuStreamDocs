...
public sealed record WyamBlogOptions(PathSegment PostsSubdirectory, string IndexTitle, bool EmitTagArchives)
{
    ...
    public WyamBlogOptions(PathSegment postsSubdirectory, string indexTitle)
