...
/// <summary>Source-generated logging helpers for the blog plugins.</summary>
internal static partial class BlogLoggingHelper
{
    ...
    internal static partial void LogDiscoveryStart(ILogger logger, string inputRoot);
    ...
    internal static partial void LogDiscoveryComplete(ILogger logger, int postCount, int draftsSkipped);
    ...
    internal static partial void LogPostDiscovered(ILogger logger, string slug, DateOnly published, string title);
    ...
    internal static void LogPostDiscovered(
        ILogger logger,
    ...
    internal static partial void LogIndexGenerated(ILogger logger, string indexPath, int archiveCount);
}
