...
{
    /// <summary>Extension members for <c>RedirectsOptions</c>.</summary>
    /// <param name="options">Options to update.</param>
    extension(in RedirectsOptions options)
    {
        ...
        /// <returns>The updated options.</returns>
        public RedirectsOptions AddHeaders(
        ...
        /// <returns>The updated options.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RedirectsOptions WithSecurityHeaders() =>
            AddHeaders(
                options,
                "/*"u8,
        ...
        /// <returns>The updated options.</returns>
        public RedirectsOptions WithoutDefaultCacheHeaders() =>
        ...
        /// <returns>The updated options.</returns>
        public RedirectsOptions WithoutMetaRefreshPages() =>
        ...
        /// <returns>The updated options.</returns>
        public RedirectsOptions WithFrontmatterKey(ReadOnlySpan<byte> key) =>
