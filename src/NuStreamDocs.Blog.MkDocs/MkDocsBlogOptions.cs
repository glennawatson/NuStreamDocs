...
public sealed record MkDocsBlogOptions(PathSegment BlogSubdirectory, byte[] IndexTitle, bool EmitCategoryArchives, int? NavOrder)
{
    ...
    public MkDocsBlogOptions(in PathSegment blogSubdirectory, byte[] indexTitle, bool emitCategoryArchives)
        : this(blogSubdirectory, indexTitle, emitCategoryArchives, NavOrder: null)
    {
    }
