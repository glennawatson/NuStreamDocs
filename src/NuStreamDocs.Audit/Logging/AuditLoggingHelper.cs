...
internal static partial class AuditLoggingHelper
{
    ...
    internal static partial void LogAuditStart(ILogger logger, string outputRoot);
    ...
    internal static partial void LogAuditFinding(ILogger logger, string page, AuditRule rule, string message);
    ...
    internal static partial void LogAuditComplete(ILogger logger, int pageCount, int findingCount);
}
